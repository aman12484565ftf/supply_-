...
export const fetchCustomerOrders = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      const response = await axios.get("https://logitrackpro.netlify.app/api/orders/user", config);
...
export const fetchOrderTracking = createAsyncThunk(
  ...
  async (trackingId, thunkAPI) => {
    try {
      ...
      const response = await axios.get(`https://logitrackpro.netlify.app/api/orders/track/${trackingId}`, config);
...
export const updateCustomerProfile = createAsyncThunk(
  ...
  async (userData, thunkAPI) => {
    try {
      ...
      const response = await axios.put("https://logitrackpro.netlify.app/api/customer/profile", userData, config);
